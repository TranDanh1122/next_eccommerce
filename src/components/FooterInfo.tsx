...
const FooterInfo = (): React.JSX.Element => {
    return <section className="container flex items-center justify-between lg:gap-32 gap-16 py-52 lg:flex-row flex-col-reverse">
