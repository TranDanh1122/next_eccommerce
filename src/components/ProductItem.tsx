    ...
    return <>
        <div className={`flex items-center flex-col gap-8 md:gap-0 lg:flex-row justify-between ${type == "reverse" ? "lg:flex-row-reverse" : "flex-row"}`}>
            ...
            <div className="lg:w-5/12 w-full">
                ...
                <h2 className="h2 mt-4 mb-8 w-1/2 lg:w-full text-center mx-auto"> XX99 Mark II Headphones</h2>
                <p className="text-black text-opacity-50 body font-medium w-4/5 lg:w-full text-center mx-auto">
