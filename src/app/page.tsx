  ...
  return (
    <>
      <main>
        ...
        <section className="container flex flex-col gap-12 overflow-hidden">
          <div className="flex items-center lg:justify-around gap-16 lg:gap-0 lg:flex-row 
                flex-col lg:py-8 py-16 px-24 bg-d8 overflow-hidden rounded-xl
                bg-[url('/assets/home/desktop/pattern-circles.svg')] bg-no-repeat bg-left ">
            <div className="w-1/3 lg:translate-y-[8%] translate-x-0 ">
              <picture>
            ...
            <div className="lg:w-1/3 w-2/3">
              <h2 className="text-white h1 lg:text-left text-center">ZX9 SPEAKER</h2>
          ...
          <div className="flex items-stretch lg:gap-8 gap-3">
            ...
            <div className="bg-f1 lg:p-24 p-8 w-1/2 flex justify-center flex-col gap-10 rounded-xl">
        ...
        <section className="container flex items-center justify-between lg:gap-32 gap-16 py-52 lg:flex-row flex-col-reverse">
          <div className="lg:w-1/2 w-full">
            <h2 className="h2 uppercase lg:text-left text-center">Bringing you the <span className="text-d8">best</span> audio gear</h2>
          ...
          <picture className="lg:w-1/2 w-full">
            ...
            <img src="/assets/shared/mobile/image-best-gear.jpg" alt="YX1 EARPHONES" className="w-full lg:aspect-square aspect-video object-cover" />
          </picture>
        </section>
      </main>
    </>
